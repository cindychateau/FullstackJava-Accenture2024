...
public class Usuario {
	...
	private List<Idea> misIdeas; //Las ideas que el usuario creó
	...
	private List<Idea> misFavoritas; //Las ideas likeadas
	
	@OneToMany(mappedBy="usuario", fetch=FetchType.LAZY)
	private List<Comentario> misComentarios; //Los comentarios que ese usuario hizo
	...
	public List<Idea> getMisIdeas() {
		return misIdeas;
	}

	public void setMisIdeas(List<Idea> misIdeas) {
		this.misIdeas = misIdeas;
	}

	public List<Idea> getMisFavoritas() {
		return misFavoritas;
	}

	public void setMisFavoritas(List<Idea> misFavoritas) {
