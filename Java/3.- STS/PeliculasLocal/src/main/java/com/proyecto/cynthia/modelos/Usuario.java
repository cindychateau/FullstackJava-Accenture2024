...
public class Usuario {
	...
	private List<Pelicula> pelisCreadas;
	...
	private List<Pelicula> pelisFavoritas;
	...
	public List<Pelicula> getPelisCreadas() {
		return pelisCreadas;
	}

	public void setPelisCreadas(List<Pelicula> pelisCreadas) {
		this.pelisCreadas = pelisCreadas;
	}

	public List<Pelicula> getPelisFavoritas() {
		return pelisFavoritas;
	}

	public void setPelisFavoritas(List<Pelicula> pelisFavoritas) {
