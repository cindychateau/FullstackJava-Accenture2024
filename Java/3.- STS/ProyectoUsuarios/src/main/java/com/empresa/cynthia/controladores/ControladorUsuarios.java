...
public class ControladorUsuarios {
	...
	@GetMapping("/usuarios/{numPagina}")
	public String desplegarUsuariosEnPagina(@PathVariable("numPagina") int numPagina,
											Model model) {
		Page<Usuario> paginaActual = serv.usuarioPorPagina(numPagina-1);
		int totalDePaginas = paginaActual.getTotalPages();
